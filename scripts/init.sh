...
conda activate /opt/anaconda3/envs/react-langchain || { echo "Error: Failed to activate the react-langchain environment."; exit 1; }

# Verify the activation
which python || { echo "Error: Python not found in the react-langchain environment."; exit 1; }
